...
function ReadingStatsTable:buildContent()
    ...
    local daily_avg_minutes = getDailyAverageMinutes(all_stats)
    ...
    local meta3_frame = makeFrame(meta3, 0, Size.padding.tiny or 2)
    ...
    local current_y = title_frame:getSize().h + meta2_frame:getSize().h + meta3_frame:getSize().h
